    ...
    public void onBindViewHolder(@NonNull CheckListViewHolder holder, int position) {
        ...
        if(MyConstants.FALSE_STRING.equals(show)){
            ...
            holder.layout.setBackgroundDrawable(context.getResources().
                    getDrawable(R.drawable.border_one));
        }
        else{
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(MyConstants.FALSE_STRING.equals(show)){
                    ...
                    if(itemsList.get(position).getChecked()){
                        toastMessage = Toast.makeText(context, "("+holder.checkBox.
                                getText()+") Packed", Toast.LENGTH_SHORT);
                    }
                    else{
                        toastMessage = Toast.makeText(context, "("+holder.checkBox.
                                getText()+") UnPacked", Toast.LENGTH_SHORT);
                    }
                    toastMessage.show();
                }
            }
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(context).setTitle("Delete (" +
                        itemsList.get(position).getItemname() + ")").setMessage("Are you sure?").
