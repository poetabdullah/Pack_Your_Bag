package com.example.pack_your_bag.Constants;
...
public class MyConstants {
   ...
   // public static final String ANOTHER_LIST = "Another List 1"; // added 1

    //public static final String ANOTHER_LIST2 = "Another List 2"; // added 2
